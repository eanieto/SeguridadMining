/*
Carga de la dimension de Abigeato
*/
...
FROM sc_fuentes_data.abigeato_2017_2

UNION
SELECT
    DISTINCT
    CASE WHEN "ARMAS MEDIOS" IN('-','NO REPORTADO') THEN 'Indeterminado' ELSE "ARMAS MEDIOS" end var_nombre_detalle
FROM sc_fuentes_data.abigeato_2018_2
UNION
SELECT
    DISTINCT
    CASE WHEN "ARMAS MEDIOS" IN('-','NO REPORTADO') THEN 'Indeterminado' ELSE "ARMAS MEDIOS" end var_nombre_detalle
FROM sc_fuentes_data.abigeato_2019_3
UNION
SELECT
    DISTINCT
    CASE WHEN "ARMAS MEDIOS" IN('-','NO REPORTADO') THEN 'Indeterminado' ELSE "ARMAS MEDIOS" end var_nombre_detalle
FROM sc_fuentes_data.abigeato_2020_0
          ) AS e
...
WITH divipola as (
    ...
    FROM sc_fuentes_data.abigeato_2017_2 LETICIA (CT)
...
left join metricas
    on metricas.var_nombre_metrica = 'Abigeato'
